...
class ImageGen:
    ...
    def get_images(self, prompt: str) -> int:
        ...
        """ single image case, hard to see for those more than 1
        {
            "imagePanels": [
                {
                "prompt": "An energetic anime-style white male character with short black hair is playfully bouncing on a large, brightly colored space hopper. 
 Beside him, a cheerful blonde female character with long, flowing hair is also playfully bouncing on a large, brightly colored space hopper.",
                "generatedImages": [
                    {
                    "encodedImage": "",
                    "seed": 329995,
...
if __name__ == "__main__":
    prompt = "An energetic anime-style white male character with short black hair is playfully bouncing on a large, brightly colored space hopper. 
 Beside him, a cheerful blonde female character with long, flowing hair is also playfully bouncing on a large, brightly colored space hopper,they are high up in the air, in a race" # TODO: use arguments
    load_dotenv()
