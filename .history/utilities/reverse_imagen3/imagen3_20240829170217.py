...
if __name__ == "__main__":
    prompt = "An energetic anime-style white male character with short black hair is playfully bouncing on a large, brightly colored space hopper. 
 Beside him, a cheerful blonde female character with long, flowing hair is also playfully bouncing on a large, brightly colored space hopper,they is high up in the air, in a race" # TODO: use arguments
    load_dotenv()
